...
public class SettingsActivity extends PreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            PreferenceCategory targetCategory = (PreferenceCategory) findPreference("close_book");

            ArrayList<CharSequence> al_entries = new ArrayList<CharSequence>();
            for (int i=1;i<=28;i+=1)
            {
                al_entries.add(Integer.toString(i));
            }
            CharSequence[] list_entries = new CharSequence[al_entries.size()];
            list_entries = al_entries.toArray(list_entries);

            customListPref.setEntries(list_entries);
            customListPref.setEntryValues(list_entries);
